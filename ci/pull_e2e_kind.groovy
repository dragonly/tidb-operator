                    ...
                    dir("${WORKSPACE}/go/src/github.com/pingcap/tidb-operator") {
                        ...
                        stage('Run') {
                            ...
                            string(credentialsId: "tp-codecov-token", variable: 'CODECOV_TOKEN')
                                ...
                                export SRC_BRANCH=${ghprbSourceBranch}
                                export GIT_COMMIT=${ghprbActualCommit}
                                export PR_ID=${ghprbPullId}
                ...
                dir("${PROJECT_DIR}") {
                    ...
                    stage("Prepare for e2e") {
                        withCredentials([
                            ...
                            BUILD_NUMBER=${BUILD_NUMBER} SRC_BRANCH=${ghprbSourceBranch} GIT_COMMIT=${ghprbActualCommit} PR_ID=${ghprbPullId} CODECOV_TOKEN=${CODECOV_TOKEN} \
                            ./hack/e2e-patch.sh
                            ...
                            SRC_BRANCH=${ghprbSourceBranch} GIT_COMMIT=${ghprbActualCommit} PR_ID=${ghprbPullId} \
